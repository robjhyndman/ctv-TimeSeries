...
-   The [foreach](http://cran.rstudio.com/web/packages/foreach/index.html) package allows general iteration over elements in a collection without the use of an explicit loop counter. Using foreach without side effects also facilitates executing the loop in parallel which is possible via the [doMC](http://cran.rstudio.com/web/packages/doMC/index.html) (using parallel/multicore on single workstations), [doSNOW](http://cran.rstudio.com/web/packages/doSNOW/index.html) (using [snow](http://cran.rstudio.com/web/packages/snow/index.html), see above), [doMPI](http://cran.rstudio.com/web/packages/doMPI/index.html) (using [Rmpi](http://cran.rstudio.com/web/packages/Rmpi/index.html)) packages, [doFuture](http://cran.rstudio.com/web/packages/doFuture/index.html) (using [future](http://cran.rstudio.com/web/packages/future/index.html) or [future.BatchJobs](http://cran.rstudio.com/web/packages/future.BatchJobs/index.html)), and [doRedis](http://cran.rstudio.com/web/packages/doRedis/index.html) (using [rredis](http://cran.rstudio.com/web/packages/rredis/index.html)) packages.
...
-   [RcppParallel](http://cran.rstudio.com/web/packages/RcppParallel/index.html)
