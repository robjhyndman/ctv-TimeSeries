...
-   The [toaster](http://cran.rstudio.com/web/packages/toaster/index.html) package by Teradata provides a set of tools to perform in-database analytics with the Teradata Aster platform (which is required).

**Parallel computing: Random numbers**

-   Random-number generators for parallel computing are available via the [rsprng](http://cran.rstudio.com/web/packages/rsprng/index.html) package by Li, and the [rlecuyer](http://cran.rstudio.com/web/packages/rlecuyer/index.html) package by Sevcikova and Rossini.
...
-   [rsprng](http://cran.rstudio.com/web/packages/rsprng/index.html)
