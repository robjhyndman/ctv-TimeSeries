...
-   The [foreach](http://cran.rstudio.com/web/packages/foreach/index.html) package allows general iteration over elements in a collection without the use of an explicit loop counter. Using foreach without side effects also facilitates executing the loop in parallel which is possible via the [doMC](http://cran.rstudio.com/web/packages/doMC/index.html) (using parallel/multicore on single workstations), [doSNOW](http://cran.rstudio.com/web/packages/doSNOW/index.html) (using [snow](http://cran.rstudio.com/web/packages/snow/index.html), see above), [doMPI](http://cran.rstudio.com/web/packages/doMPI/index.html) (using [Rmpi](http://cran.rstudio.com/web/packages/Rmpi/index.html)), 
[doFuture](http://cran.rstudio.com/web/packages/doFuture/index.html) (using [future](http://cran.rstudio.com/web/packages/future/index.html) or [future.BatchJobs](http://cran.rstudio.com/web/packages/future.BatchJobs/index.html)) and [doRedis](http://cran.rstudio.com/web/packages/doRedis/index.html) (using [rredis](http://cran.rstudio.com/web/packages/rredis/index.html)) packages.
-   The [future](http://cran.rstudio.com/web/packages/future/index.html) package allows for synchroneous (sequential) and asynchronous (parallel) evaluations via abstraction of futures, either via function calls or implicitly via promises. Global variables are automatically identified. Iteration over elements in a collection is supported. The [future.BatchJobs](http://cran.rstudio.com/web/packages/future.BatchJobs/index.html) package resolves futures via compute cluster job schedulers (e.g. Slurm, TORQUE / PBS, Sun Grid Engine and LSF) by utilizing the [BatchJobs](http://cran.rstudio.com/web/packages/BatchJobs/index.html) framework.
...
-   The [<span class="BioC">maanova</span>](http://www.Bioconductor.ohttp://cran.rstudio.com/web/packages/release/bioc/html/maanova.html) package on Bioconductor by Wu can use [snow](http://cran.rstudio.com/web/packages/snow/index.html) and [Rmpi](http://cran.rstudio.com/web/packages/Rmpi/index.html) for the analysis of micro-array experiments.
...
-   The [RcppParallel](http://cran.rstudio.com/web/packages/RcppParallel/index.html) package by Allaire et al. bundles the [Intel Threading Building Blocks](https://www.threadingbuildingblocks.org) and [TinyThread](http://tinythreadpp.bitsnbites.eu) libraries. Together with [Rcpp](http://cran.rstudio.com/web/packages/Rcpp/index.html), RcppParallel makes it easy to write safe, performant, concurrently-executing C++ code, and use that code within R and R packages.
...
-   [doFuture](http://cran.rstudio.com/web/packages/doFuture/index.html)
...
-   [future.BatchJobs](http://cran.rstudio.com/web/packages/future.BatchJobs/index.html)
...
-   Bioconductor Package: [<span class="BioC">affyPara</span>](http://www.Bioconductor.ohttp://cran.rstudio.com/web/packages/release/bioc/html/affyPara.html)
-   Bioconductor Package: [<span class="BioC">maanova</span>](http://www.Bioconductor.ohttp://cran.rstudio.com/web/packages/release/bioc/html/maanova.html)
-   Bioconductor Package: [<span class="BioC">multtest</span>](http://www.Bioconductor.ohttp://cran.rstudio.com/web/packages/release/bioc/html/multtest.html)
-   Bioconductor Package: [<span class="BioC">puma</span>](http://www.Bioconductor.ohttp://cran.rstudio.com/web/packages/release/bioc/html/puma.html)
